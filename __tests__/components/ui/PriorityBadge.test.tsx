// PriorityBadge — 공통 UI 프리미티브 (docs/COMPONENT_SPEC.md §3 PriorityBadge, docs/FRONTEND_TASKS.md Phase 0 참조)
...
describe("PriorityBadge", () => {
  describe.each(Object.entries(PRIORITY_CLASSES))("priority=%s", (priority, classes) => {
    it(`priority="${priority}"이면 해당 색상 클래스와 "${priority}" 텍스트가 표시된다`, () => {
      render(<PriorityBadge priority={priority as keyof typeof PRIORITY_CLASSES} />);
